...
# noisy_latitude= []
# noisy_longitude= []
def obufused_worker(num, worker_data, lat, lon, epsilon):
    ...
    obu_worker = 'Worker_Jan_26_Tokyo_' + str(num) +'\\'+'worker_Tokyo_' + str(num) + '_' + str(epsilon) + '.csv'
...
for num in range(10, 60, 10):
    # for hour in range(1, 25, 1):
        ...
        real_worker = 'Worker_Jan_26_Tokyo_' + str(num) +'\\'+'worker_Tokyo_' + str(num) + '.csv'
        ...
        obufused_worker(num, taxi_data, lat, lon, epsilon)
